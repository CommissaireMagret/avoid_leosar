...
def predict_passes(num_passes, time_start_epoch):
    global qth
    ...
    p1 = predict.transits(tle1, qth, time_start_epoch)
    p2 = predict.transits(tle2, qth, time_start_epoch)
    p3 = predict.transits(tle3, qth, time_start_epoch)
    p4 = predict.transits(tle4, qth, time_start_epoch)
    p5 = predict.transits(tle5, qth, time_start_epoch)
...
def create_slots(num_slots, duration_seq, time_start):
    ...
    passes = predict_passes(num_slots * int(10 * duration_seq / 30), time_start_epoch)
